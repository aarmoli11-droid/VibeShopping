...
/// Tema global VibeShopping (logo + mockup login).
/// - Primario: azul marino (botones, barras, texto fuerte).
...
abstract final class VibeTheme {
    ...
    return ThemeData(
      ...
      navigationBarTheme: NavigationBarThemeData(
        ...
        labelTextStyle: WidgetStateProperty.resolveWith((states) {
          ...
          return TextStyle(
            color: selected ? VibeColors.navy : VibeColors.navy.withValues(alpha: 0.65),
        ...
        iconTheme: WidgetStateProperty.resolveWith((states) {
          ...
          return IconThemeData(
            color: selected ? VibeColors.navy : VibeColors.navy.withValues(alpha: 0.55),
          );
        }),
      ),
  ...
  /// Degradado suave tipo logo (mint → blanco) para fondos de pantalla.
